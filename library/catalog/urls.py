...
from .views import BooksView, BookCreateView, BookDetailView, BookUpdateView, BookDeleteView, AuthorCreateView
...
urlpatterns = [
    ...
    path('autor/nowy', AuthorCreateView.as_view(), name='author-create-view'),
]
